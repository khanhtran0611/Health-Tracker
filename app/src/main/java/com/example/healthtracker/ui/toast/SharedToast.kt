...
import com.example.healthtracker.ui.theme.ToastContentColor
import com.example.healthtracker.ui.theme.ToastErrorColor
import com.example.healthtracker.ui.theme.ToastSuccessColor
import com.example.healthtracker.ui.theme.ToastWarningColor
    ...
    AnimatedVisibility(
        ...
        displayData?.let { data ->
            val backgroundColor = when (data.type) {
                ...
                ToastType.WARNING -> ToastWarningColor
