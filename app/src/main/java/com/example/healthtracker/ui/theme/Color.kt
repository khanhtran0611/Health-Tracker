...
val ObsidianPrimary = Color(0xFFA78BFA)

val ObsidianOnPrimary = Color(0xFF09090B)
val ObsidianPrimaryContainer = Color(0xFF2E1F63)
val ObsidianOnPrimaryContainer = Color(0xFFD9CCFC)
...
val ObsidianTertiary = Color(0xFF34D399)

val ObsidianOnTertiary = Color(0xFF09090B)
val ObsidianTertiaryContainer = Color(0xFF0B3B2A)
val ObsidianOnTertiaryContainer = Color(0xFFA7F3D0)

val ObsidianError = Color(0xFFEF4444)
val ObsidianOnError = Color(0xFFFFFFFF)
val ObsidianErrorContainer = Color(0xFF450A0A)
val ObsidianOnErrorContainer = Color(0xFFFCA5A5)

val ObsidianBackground = Color(0xFF09090B)
val ObsidianOnBackground = Color(0xFFFAFAFA)
val ObsidianSurface = Color(0xFF0C0C0F)
val ObsidianOnSurface = Color(0xFFFAFAFA)
val ObsidianSurfaceVariant = Color(0xFF27272A)
val ObsidianOnSurfaceVariant = Color(0xFFA1A1AA)

val ObsidianOutlineVariant = Color(0xFF27272A)
